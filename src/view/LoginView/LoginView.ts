export default class LoginView {
  ...
  public static loginWindowStyles = ['bg-white', 'w-2/4', 'h-2/4', 'text-center', 'm-auto', 'absolute', 'top-1/4', 'bottom-1/4', 'left-1/4', 'right-1/4', 'max-w-500'];

  public static loginLabelAttributes = [
    ['for', 'login']
  ];
  ...
  public static passwordLabelAttributes = [
    ['for', 'password']
  ];
  ...
  public static okButtonAttributes = [
    ['id', 'submit-login']
  ];

  public static cancelButtonAttributes = [
    ['id', 'cancel-login']
  ];

  public static loginErrorAttributes = [
    ['id', 'loginError']
  ];
  ...
  public static addValidation() {
    const loginInput = document.getElementById('login');
      ...
      const passwordErrorText = 'Password does not meet a complexity criteria:<br>1. At least 8 characters long<br>2. At least one uppercase letter (A-Z)<br>3. At least one lowercase letter (a-z)<br>4. At least one digit (0-9)<br>5. At least one special character (!@#$%^&*)<br>6. Of no leading or trailing whitespace<br>'
      const loginErrorText = 'Login does not meet requirements:<br>Email address must be properly formatted (e.g., user@example.com)<br>Email address must not contain leading or trailing whitespace<br>Email address must contain a domain name (e.g., example.com)<br>Email address must contain an &commat; symbol separating local part and domain name<br>';
